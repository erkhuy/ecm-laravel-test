...
<body class="hold-transition sidebar-mini" >
    ...
    <div  class="wrapper" >
      ...
      <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        ...
        <form class="form-inline ml-3" >
                <div class="input-group input-group-sm">
                  <input class="form-control form-control-navbar" v-model="searchKey" type="search" placeholder="Search" aria-label="Search">
      ...
      <!-- Main Sidebar Container -->
        <div id="app">
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <img src="{{asset('images/admin/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <a href="">h</a>.</strong> All rights reserved.
      </footer>
    </div>
    <!-- ./wrapper -->
